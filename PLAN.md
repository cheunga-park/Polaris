...
**환경별 결과(2026-09-10~14, 최종 설정 = 링크 프레임·장착각·그리퍼 ×16·높이맵 지지면(배치 영역 p90 채움, 용기 아래 채움, 구멍 다리)·마찰 0.5, 30회씩)**

| 환경 | 수정 전(50회) | 최종 | 논문 | Isaac 재현(issue #24) |
|---|---|---|---|---|
| PanClean | 0.34 / 0 % | 0.66 / 13 % (90회 합산 0.62 / 14 %) | 0.55 | 0.75 / 37 % |
| FoodBussing | 0.33 / 0 % | 0.51 / 0 % (구멍 다리 후) | 0.58 | 0.58 / 17 % |
| BlockStack | 0.25 / 0 % | 0.36 / 3 % | 0.54 | 0.50 / 2 % |
| Tape | 0.10 / 0 % | 0.12 / 3 % | 0.80 | 0.34 / 23 % (리셋 파손) |

공통 잔여 모드: 마지막 "그리퍼 열고 용기 안" 기준 미달(쥔 채 문지름/보유, 놓은 뒤 이탈). FoodBussing 진단(6회): 아이스크림은 들어 올려 그릇에 넣고 놓는 에피소드 2/6, 포도는 최대 3 cm 만 들려 lift 기준(6 cm) 미달, 그릇이 1.6–9 cm 밀림(강체).

**최종 스윕 `pi05_final`(2026-09-14, 배치 영역 평면화 포함, 50/50/50/30회)**

| 환경 | 수정 전 | 최종 | 논문 | Isaac 재현 |
|---|---|---|---|---|
| PanClean | 0.34 / 0 % | **0.66 / 18 %** (Wilson 11–29) | 0.55 | 0.75 / 37 % |
| FoodBussing | 0.33 / 0 % | **0.50 / 0 %** | 0.58 | 0.58 / 17 % |
| BlockStack | 0.25 / 0 % | **0.40 / 0 %** | 0.54 | 0.50 / 2 % |
| Tape | 0.10 / 0 % | 0.18 / 3 % | 0.80 | 0.34 / 23 % (리셋 파손) |

잔여 원인(진단): 마지막 "그리퍼 열고 용기 안" 기준 — PanClean 은 쥔 채 문지름, FoodBussing 은 포도(울퉁불퉁한 강체 송이, 넓은 부분을 낮게 집을 때만 유지) 들기 6 cm 미달, BlockStack 은 나무 큐브 트레이 배치·쌓기 미달. 공통으로 강체 물체와 강체 패드의 마찰 유지력이 실제(연성)보다 약하다는 한계. 문서: docs/REPORT_pi05_final.md, 결과 웹 /results.html.

**남은 게이트**: 잔여 원인별 추가 수정(패드 연성·물체 연성 근사) 판단, 그리고 **실제 폰 영상**.
